...
ACTION_DEFINITIONS: tuple[ActionDefinition, ...] = (
    ...
    ActionDefinition("shape_keys.create_auto_prefix", "Create Shape Key from Common Prefix", "lcw.shape_key_create_auto_prefix", "Shape Keys", ("text_value",)),
    ActionDefinition("shape_keys.animate_partial", "Keyframe Shape Keys by Name Fragment", "lcw.shape_key_animate_partial", "Shape Keys", ("list_value", "int_value", "int_value_2", "float_value", "float_value_2")),
